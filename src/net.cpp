...
static const char *strMainNetDNSSeed[][2] = {
    {"freecointools.com", "dnsseed.freecointools.com"},
    {"freecoinpool.org", "dnsseed.freecoinpool.org"},
    {"xurious.com", "dnsseed.FRC.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"freecointools.com", "testnet-seed.freecointools.com"},
    {"xurious.com", "testnet-seed.FRC.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. freecoin is probably already running."), addrBind.ToString().c_str());
        else
